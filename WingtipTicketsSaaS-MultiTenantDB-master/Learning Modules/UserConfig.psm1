...
$ResourceGroupName = "ShareDbTest" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "hiral"         # the User value entered when the Wingtip SaaS application was deployed
